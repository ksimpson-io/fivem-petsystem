...
mc9.callback.create("frudy-pets:server:GetPetPrices", function()
	return PetPrices()
end)

mc9.callback.create("frudy-pets:server:GetPets", function()
	return PetData.Pets
end)

mc9.callback.create('frudy-pets:server:GetPlayerPets', function(source, cid)
